 ...
 * Push button to change to the next mode.
 * Push button for > 1 second to write the current mode to EEPROM.
...
#define BUTTON_PIN 6                                          // Connect a buttonor something similar from Arduino pin 6 to ground.
