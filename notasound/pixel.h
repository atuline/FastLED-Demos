...
// Temporary local variables
  ...
  CRGB newcolour = ColorFromPalette(currentPalette, sample, sample, currentBlending);   // Colour of the LED will be based on the sample, while brightness is based on sampleavg.
