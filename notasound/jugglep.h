...
// Temporary local variables
  ...
  leds[beatsin16(thistime,0,NUM_LEDS-1, 0, 0)] += ColorFromPalette( currentPalette, millis()/4, sampleavg, currentBlending);
  leds[beatsin16(thistime-3,0,NUM_LEDS-1, 0, 0)] += ColorFromPalette( currentPalette, millis()/4, sampleavg, currentBlending);
